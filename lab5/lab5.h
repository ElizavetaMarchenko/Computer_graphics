...
static const TextureVertex SquareVertices[] = {
    {1.0f, -0.5f,  0.5f, 0.0f, 0.0f}, // 0
    {1.0f, -0.5f, -0.5f, 1.0f, 0.0f}, // 1
    {1.0f,  0.5f, -0.5f, 1.0f, 1.0f}, // 2
    {1.0f,  0.5f,  0.5f, 0.0f, 1.0f}, // 3

    {1.1f, -0.5f,  0.5f, 0.0f, 0.0f}, // 4
    {1.1f, -0.5f, -0.5f, 1.0f, 0.0f}, // 5
    {1.1f,  0.5f, -0.5f, 1.0f, 1.0f}, // 6
    {1.1f,  0.5f,  0.5f, 0.0f, 1.0f}  // 7
};
...
float4 ps(VSOutput pixel) : SV_Target
{
    return color; // Используем цвет из константного буфера
}
)";
